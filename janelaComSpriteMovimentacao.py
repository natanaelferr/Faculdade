###
###
### Warning! Contém cenas fortes... não foi usado IA!
###
###
...
pos_x = 0  # Posição inicial do sprite no eixo X
pos_y = 0  # Posição inicial do sprite no eixo Y
...
while rodando:
    ...
    if teclas[pygame.K_UP]:
        pos_y -= movimento  # Move pra cima
    if teclas[pygame.K_DOWN]:
        pos_y += movimento  # Move pra baixo

    # Mantém o sprite dentro da janela no eixo X
    if pos_x < 0:
        pos_x = 0
    elif pos_x > 170:
        pos_x = 170
    # Mantém o sprite dentro da janela no eixo Y
    if pos_y < 0:
        pos_y = 0
    elif pos_y > 100:
        pos_y = 100
    ...
    # Mantém o sprite sem colidir com o botão
    if pos_x > 101 and pos_x <= 170:
        if pos_y > 50:
            pos_y = 50
    elif pos_y > 50 and pos_y <= 100:
        if pos_x > 100:
            pos_x = 100
